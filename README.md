...
### APP deployada -> [Buen Sabor FES](https://el-buen-sabor-frontend.vercel.app/)


Para correr la app en local debemos configurar la url de conección a la base de datos y además en la raíz del proyecto hay un archivo bbdd.sql con los datos iniciales en el caso de crear su propia base de datos. Para esto, solo crear la base de datos con nombre “rest_generica”, correr el backend (creará las tablas) y ejecutar las queries del archivo bbdd.sql.
